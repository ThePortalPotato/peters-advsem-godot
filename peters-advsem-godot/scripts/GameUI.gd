...
var prestige = load("res://scenes/prestige-menu.tscn").instantiate()
...
func _ready() -> void:
	...
	$/root/MainLevel/CanvasLayer.add_child.call_deferred(prestige)
...
func update_ui() -> void:
	...
	%"Fish Per Second".text = "%s fish/sec" % GameManager.format_number(GameManager.get_effective_fps())
...
func _on_prestige_button_pressed() -> void:
	prestige.visible = !prestige.visible
	AudioManager.playOneshot2D(SFXStreams.BUTTON_CLICK)
